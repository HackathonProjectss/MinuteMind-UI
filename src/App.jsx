          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
            <div className="text-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                ...
                <span className="block text-pink-400 xl:inline">Into Actionable Insights</span>
              </h1>
              <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl">
                MinuteMind uses AI to convert your meeting audio into comprehensive summaries and personalized action items for each participant.
              </p>
                  ...
                  <div className="-mt-6">
                    <div>
                      <span className="inline-flex items-center justify-center p-3 bg-pink-500 rounded-md shadow-lg">
                        <FaMicrophone className="h-6 w-6 text-white" aria-hidden="true" />
                      </span>
                    </div>
                    <h3 className="mt-8 text-lg font-medium text-white tracking-tight">AI-Powered Transcription</h3>
                    <p className="mt-5 text-base text-gray-400">
                      Our advanced AI accurately transcribes your meeting audio, capturing every important detail.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="-mt-6">
                    <div>
                      <span className="inline-flex items-center justify-center p-3 bg-indigo-500 rounded-md shadow-lg">
                        <FaClipboardList className="h-6 w-6 text-white" aria-hidden="true" />
                      </span>
                    </div>
                    <h3 className="mt-8 text-lg font-medium text-white tracking-tight">Smart Summaries</h3>
                    <p className="mt-5 text-base text-gray-400">
                      Get concise, intelligent summaries that highlight key points and decisions from your meetings.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="-mt-6">
                    <div>
                      <span className="inline-flex items-center justify-center p-3 bg-purple-500 rounded-md shadow-lg">
                        <FaRocket className="h-6 w-6 text-white" aria-hidden="true" />
                      </span>
                    </div>
                    <h3 className="mt-8 text-lg font-medium text-white tracking-tight">Personalized Action Items</h3>
                    <p className="mt-5 text-base text-gray-400">
                      Automatically generate and assign action items to team members, ensuring follow-through on decisions.
                    </p>
                  </div>
                </div>
              </div>
...
//                 <span className="block xl:inline">Transform your meetings</span>{" "}
//                 <span className="block text-indigo-600 xl:inline">into actionable insights</span>
//               </h2>
...
//         </div>
//       </div>
//       <div className="lg:absolute top-0 lg:inset-y-0 lg:right-0 lg:w-1/2">
//         <img
//           className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
//           src="https://images.unsplash.com/photo-1573167243872-43c6433b9d40?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2069&q=80"
